...
import { ImageUpload } from "../../Utils/services";
...
export default function ReportModel({ open, setOpen, webid }) {
  ...
  const updatesatus = async () => {
    ...
    const result = await ImageUpload(formData, webid);
          ...
          <div id="modal-desc" textColor="text.tertiary">
            <div className="ReportModel">
              <div className="peoplelabin">
                <h2 style={{ fontSize: '22px', color: '#223F63', fonWeight: '600', fontFamily: 'Inter' }}>Upload Report</h2>
                <div className="">
